...
const Main = () => {
  ...
  const {onSent, recentPrompt, setRecentPrompt, prevPrompts, setPrevPrompts, input, setInput, showResults, setShowResults, loading, resultData, setResultData} = useContext(Context)
